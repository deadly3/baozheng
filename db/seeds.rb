...
create_account = User.create([email: 'admin@1', password: '123123', password_confirmation: '123123', is_admin: 'true', nickname: '达人1', token: "f5dbe66e3408e0be"])
create_account = User.create([email: '1@1', password: '111111', password_confirmation: '111111', is_admin: 'true', nickname: '达人2', token: "ewdbe66e3408e0be"])
create_account = User.create([email: '2@2', password: '111111', password_confirmation: '111111', is_admin: 'true', nickname: '达人3', token: "f5dwe66e3408e0be"])
puts "管理员建立成功."
